...
console.log(
  `Auth middleware using JWT secret: ${JWT_SECRET.substring(0, 3)}...`
);
...
export const authenticate = async (
  ...
  try {
    console.log(
      `Authentication middleware running for ${req.method} ${req.path}`
    );
    ...
    console.log(
      `Authentication successful for user: ${user.email} (ID: ${user.id})`
    );
